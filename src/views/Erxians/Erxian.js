...
import Formprint from "../MyAspirations/MyAspirations.js";
...
export default function Erxian() {
  ...
  if (state.redirect) {
    ...
    return (
      <div>
        <center> <Card style={{padding:"12px", margin:"0px", width:"100%" ,boxShadow:"rgb(0 0 0 / 14%) 0px 4px 20px 0px, rgb(70 70 70 / 40%) 0px 7px 10px -5px",borderRadius:"5px"}}>
        <GridContainer>
          <GridItem md={7}>
            <div style={{display:"inline-block",marginRight:"20px"}}> <h4 style={{display:"inline-block"}}>Student ID : </h4> <span style={{display:"inline-block"}}> 545 </span> </div>
            <div style={{display:"inline-block",marginRight:"20px"}}> <h4 style={{display:"inline-block"}}>Name : </h4>  <span style={{display:"inline-block"}}> Anirud </span>  </div>
            <div style={{display:"inline-block",marginRight:"20px"}}> <h4 style={{display:"inline-block"}}>DOB : </h4> <span style={{display:"inline-block"}}> 18-01-1996 </span> </div>
            <div style={{display:"inline-block"}}> <h4 style={{display:"inline-block"}}>Phone NO : </h4>  <span style={{display:"inline-block"}}> 9565 655 525 </span>  </div>
            </GridItem>
          <GridItem md={5}>
            <h5 style={{display:"inline-block",marginRight:"20px"}}> Select Another Erxian </h5> <Button round color="primary"> Select </Button>
          </GridItem>
    </GridContainer>
    </Card> </center>
...
<CustomTabs
            ...
            tabs={[
              ...
              {
                tabName: "Indenification",
                tabContent: (
                  <>content</>
                )
              },
              {
                tabName: "Correspondance",
                tabContent: (
                  <>content</>
                )
              }
            ...
            <TableBody>
              {newRows.map((row) => (
                <StyledTableRow key={row.ID}>
                  ...
                  <StyledTableCell align="center"><ArrowRightAltIcon onClick={() => { setCurrRow(row); setState({ ...state, redirect: true }) }} /></StyledTableCell>
                </StyledTableRow>
              ))}
            </TableBody>
          </Table>
